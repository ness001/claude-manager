...
- [x] "Install Plugin" header button has no onClick handler (`src/components/plugins/PluginListView.tsx:59-65`) — disabled with explanatory tooltip until install IPC lands — PR #TBD
