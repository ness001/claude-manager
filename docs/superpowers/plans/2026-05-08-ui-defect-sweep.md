...
- [x] `McpServerForm` URL input (`src/components/mcp/McpServerForm.tsx:233-241`, sse/http branch) had no accessible name — same defect class as PR #77 (Name) / PR #78 (Command). Added `aria-label="URL"` directly on the input. WCAG 4.1.2. — PR #79
- [ ] _further investigation pending_
