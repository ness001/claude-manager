...
- [x] Remove button has no onClick handler (`src/components/plugins/PluginCard.tsx:115-128`) — disabled with explanatory tooltip until uninstall IPC lands — PR #TBD
